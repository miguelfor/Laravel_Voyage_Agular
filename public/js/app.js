 ...
 $scope.lang = "Eng";
	...
	*/
	...
	$scope.add = function(producto)
	{
		...
		product.price = producto.price_it;
		product.name = producto.title_en;
		product.category = producto.category_id;
	...
	*/
	//$location.url('http://localhost:8000/api/products');
   ...
   $scope.productosTienda = data;
	...
	//$scope.productosTienda2 = angular.fromJson("http://localhost:8000/api/products");
	$scope.productosTienda2 = 
	[
